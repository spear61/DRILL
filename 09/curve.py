...
def draw_middle_curve(p1,p2, p3, p4):
    for i in range(0, 100, 2):
        t = i / 100
...
def draw_curve_4_points(p1, p2, p3, p4):
    ...
    while True:
        draw_middle_curve(p3, p4, p1, p2)
        draw_middle_curve(p4, p1, p2, p3)
        draw_middle_curve(p1, p2, p3, p4)
        draw_middle_curve(p2, p3, p4, p1)
